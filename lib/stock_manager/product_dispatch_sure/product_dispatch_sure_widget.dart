...
import 'product_dispatch_sure_model.dart';
export 'product_dispatch_sure_model.dart';

class ProductDispatchSureWidget extends StatefulWidget {
  const ProductDispatchSureWidget({Key? key}) : super(key: key);

  @override
  _ProductDispatchSureWidgetState createState() =>
      _ProductDispatchSureWidgetState();
}

class _ProductDispatchSureWidgetState extends State<ProductDispatchSureWidget> {
  late ProductDispatchSureModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductDispatchSureModel());
